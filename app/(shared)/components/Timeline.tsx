...
export function Timeline({ currentAge, milestones, maxAge = 100 }: TimelineProps) {
  ...
  return (
    <div className="relative w-full bg-white rounded-2xl shadow-sm p-8">
      {/* タイムラインの背景 */}
      ...
      >
        <div className="relative">
          ...
          <div className="absolute top-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
            <div className="text-sm font-medium text-blue-600">現在</div>
      ...
      {sortedMilestones.map((milestone, index) => (
        ...
        >
          <div className="relative">
            ...
            <div className="absolute top-6 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
              <div className="text-xs font-medium text-gray-700">{milestone.name}</div>
              <div className="text-xs text-gray-500">{milestone.targetAge}歳</div>
              <div className="text-xs text-gray-500">あと{milestone.targetAge - currentAge}年</div>
            </div>
          </div>
        </motion.div>
      ))}
      ...
      {/* 年齢の目盛り */}
      <div className="absolute w-full top-0 flex justify-between text-xs text-gray-400 mt-1">
        <span>0</span>
        <span>25</span>
        <span>50</span>
        <span>75</span>
